  ...
  return (
    <footer style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              Fast, secure web solutions and payment integrations that help startups and businesses grow faster across Kenya and beyond.
            </p>
              ...
              {socialLinks.map(({ icon: Icon, href, label, color }) => (
                <a
                  ...
                  onMouseEnter={e => {
                    ...
                    e.currentTarget.style.background = "#132050"
                  }}
                  onMouseLeave={e => {
                    e.currentTarget.style.color = "#8892b0"
                    e.currentTarget.style.borderColor = "rgba(0,201,255,0.15)"
                    e.currentTarget.style.background = "#0f1a3d"
                  }}
                >
                  <Icon />
                </a>
          ...
          <div>
            <h4 style={{
              ...
              color: "#e8eeff", letterSpacing: "1.5px",
        ...
        {/* Bottom bar */}
        <div style={{
          borderTop: "0.5px solid rgba(0,201,255,0.10)",
          paddingTop: "1.5rem",
          display: "flex",
          alignItems: "center",
          ...
          <p style={{ fontSize: "0.8rem", color: "#8892b0" }}>
            © {year} LakesideTech. All rights reserved.
          </p>
          <p style={{ fontSize: "0.8rem", color: "#8892b0" }}>
            Built by{" "}
